...
static inline void FloorImRect(ImRect& rect)
{
    rect.Min.x = std::floor(rect.Min.x);
    rect.Min.y = std::floor(rect.Min.y);
    rect.Max.x = std::floor(rect.Max.x);
    rect.Max.y = std::floor(rect.Max.y);
}
